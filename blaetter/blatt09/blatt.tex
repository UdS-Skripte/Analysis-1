...
\section*{Aufgabe 5}
Wir suchen alle (komplexen) Lösungen von $\sqrt[6]{64}$. Aus dem Fundamentalsatz der Algebra folgt (nicht direkt), dass es sechs komplexe Lösungen $w_0, \dots, w_5$ gibt. Wir stellen zunächst $-64$ in Polarkoordinaten dar als
\begin{align*}
    -64 = 64 \mathrm{e}^{i \pi}
\end{align*}
Laut Vorlesung sind diese Lösungen in der Form
\begin{align*}
    w_k = \vert \sqrt[6]{64} \vert \mathrm{e}^{i \frac{\pi + 2\pi k }{6}}\\
\end{align*}
Somit erhalten wir für $k = 0, \dots, 5$:
\begin{align*} 
    w_0 = 2 \mathrm{e}^{i \frac{\pi + 2\pi \cdot 0 }{6}} & = 2 \mathrm{e}^{i \frac{\pi}{6}}\\
    w_1 = 2 \mathrm{e}^{i \frac{\pi + 2\pi \cdot 1 }{6}} & = 2 \mathrm{e}^{i \frac{\pi}{2}}\\
    w_2 = 2 \mathrm{e}^{i \frac{\pi + 2\pi \cdot 2 }{6}} & = 2 \mathrm{e}^{i \frac{5 \pi}{6}}\\
    w_3 = 2 \mathrm{e}^{i \frac{\pi + 2\pi \cdot 3 }{6}} & = 2 \mathrm{e}^{i \frac{7 \pi}{6}}\\
    w_4 = 2 \mathrm{e}^{i \frac{\pi + 2\pi \cdot 4 }{6}} & = 2 \mathrm{e}^{i \frac{3 \pi}{2}}\\
    w_5 = 2 \mathrm{e}^{i \frac{\pi + 2\pi \cdot 5 }{6}} & = 2 \mathrm{e}^{i \frac{11 \pi}{6}}\\
\end{align*}
